...
export const FormSection: React.FC<{ title?: string; children: React.ReactNode }> = ({ title, children }) => (
    <div className="bg-white p-6 rounded-xl border border-brand-200/70 shadow-sm">
        {title && <h3 className="text-sm font-bold uppercase tracking-wider text-slate-500 mb-6">{title}</h3>}
