        ...
        const footer = (
            <div className="flex justify-between items-center w-full">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button type="submit" form={`contact-window-form-${windowId}`} disabled={isSubmitting} className="bg-primary hover:brightness-110 text-primary-foreground font-semibold py-2 px-4 rounded-md flex items-center text-sm disabled:opacity-50">
