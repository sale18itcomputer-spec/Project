...
import { Check, Pencil, Trash2, ChevronDown, ChevronUp, Loader2 } from 'lucide-react';
...
const SerialNumberWindowContent: React.FC<SerialNumberWindowContentProps> = ({
    ...
    }, [isEditMode, existingSN, windowId, closeWindow]);
    ...
    useEffect(() => {
        const title = isEditMode
            ? (isReadOnly ? `Serial: ${formData.serial_number}` : `Editing: ${formData.serial_number}`)
            : 'Add Serial Number';
    ...
    }, [windowId, isEditMode, isReadOnly, isSaving, formData.serial_number, updateWindow, closeWindow, handleCancelClick]);
