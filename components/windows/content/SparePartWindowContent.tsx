    ...
    useEffect(() => {
        ...
        const footer = isReadOnly ? (
            ...
            <div className="flex justify-end gap-3 w-full">
                ...
                <button type="submit" form={`spare-part-window-form-${windowId}`} disabled={isSaving} className="bg-primary hover:brightness-110 text-primary-foreground font-semibold py-2 px-4 rounded-md flex items-center text-sm disabled:opacity-50">
