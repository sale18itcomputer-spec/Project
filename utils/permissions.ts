...
export const ROLE_PRESETS: Record<string, UserPermissions> = {
  Admin: {
    modules: {
      ...
      service_invoices:   { view: true, create: true, edit: true, delete: true },
  ...
  Sales: {
    modules: {
      ...
      service_invoices:   { view: true, create: true, edit: true, delete: false },
  ...
  User: {
    modules: {
      ...
      service_tickets:    { view: false, create: false, edit: false, delete: false },
      service_invoices:   { view: false, create: false, edit: false, delete: false },
      pdi_records:        { view: false, create: false, edit: false, delete: false },
      serial_numbers:     { view: false, create: false, edit: false, delete: false },
      spare_parts:        { view: false, create: false, edit: false, delete: false },
