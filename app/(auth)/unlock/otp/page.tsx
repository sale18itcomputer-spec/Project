            ...
            <div className="w-full max-w-sm flex flex-col items-center animate-in fade-in zoom-in-95 duration-300">
                ...
                {stage === 'rate-limited' && (
                    <>
                        ...
                        <p className="text-sm text-muted-foreground text-center px-4 mb-6 leading-relaxed">
                        ...
                        <div className="w-full space-y-3">
                            <button
                                onClick={handleRetry}
                                className="w-full h-12 bg-primary hover:brightness-110 text-primary-foreground font-medium rounded-lg transition-colors flex items-center justify-center gap-2 shadow-[0_0_20px_hsl(var(--primary)/0.2)]"
                            >
